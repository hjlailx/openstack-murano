...
public class NetWorking {
	...
	protected NetWorking(String id, String type, String status) {
		this.id = id ;
		this.type = type ;
		this.status = status ;
	}
	...
	public boolean equals(Object obj) {
		...
		if (obj == null || getClass() != obj.getClass())
			return false;
		NetWorking that = NetWorking.class.cast(obj);
	...
	public abstract static class Builder {
		...
		public NetWorking build() {
			return new NetWorking(id, type, status);
		}

		public Builder fromCategory(NetWorking in) {
